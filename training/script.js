...
async function loadMobileNetFeatureModel() {
  ...
  STATUS.innerText = 'MobileNet v3 loaded successfully!\n' + '1. Enable webcam\n' + ' 2. Press and hold button to create training examples for each object.\n' 
  + '3. Press Train & Predict button to train and download the new model, it will be located in your /Downloads folder\n';
